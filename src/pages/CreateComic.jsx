...
export default function CreateComic() {
    ...
    async function onSubmit(event) {
        ...
        setButtonText(
            <div class="w-8 h-8 border-8 border-dashed rounded-full animate-spin border-white-600"></div>
        );
    ...
    return <div>
        <Navbar />
        <div class = "pt-3 mb-2 text-1xl font-bold tracking-tight text-gray-900 dark:text-white">
            <h1>
                Click on the blank canvases below to create your unique comic.
            </h1>
        </div>
        <Modal
            ...
            <div>
                <div class="pt-2 pb-2 float-right absolute right-3 top-1">
                    <button onClick={closeModal} id="cancelButton" 
                        class="bg-blue-500 hover:bg-blue-700 py-1 px-1 text-white font-bold rounded focus:outline-none focus:shadow-outline">
                ...
                <form class="bg-white rounded px-8 pb-5 mb-0 mt-5">
                    <div class="mb-4">
                        ...
                        <input 
                            ...
                            id="prompt" type="text" placeholder="Enter the prompt" autoComplete="off" 
                        />
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700 text-md font-bold mb-2" for="username">
                        ...
                        <input 
                            ref={textRef} maxlength="20" 
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
                            id="strip-text" type="text" placeholder="Enter the text" autoComplete="off" 
                        />
                    </div>
